          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
           ...
           <div className="overflow-x-auto mt-6">
              <table className="min-w-full border border-gray-300 text-xs sm:text-sm md:text-base">
                ...
                <tbody>
                    <tr>
                        <td className="px-2 sm:px-4 py-2 border border-gray-300">English</td>
                        <td className="px-2 sm:px-4 py-2 border border-gray-300">25</td>
                        <td className="px-2 sm:px-4 py-2 border border-gray-300">100</td>
                        <td className="px-2 sm:px-4 py-2 border border-gray-300">60 min</td>
