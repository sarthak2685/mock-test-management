...
const Analysis = () => {
    ...
    useEffect(() => {
      ...
      const storedTotalQuestion = localStorage.getItem("totalQuestion");
      // Log the values to the console
  console.log("Stored Correct Answers:", storedCorrectAnswers);
  console.log("Stored Wrong Answers:", storedWrongAnswers);
  console.log("Stored Total Question:", storedTotalQuestion);
  
      // Set the values into state
      if (storedCorrectAnswers !== null && storedWrongAnswers !== null) {
        setCorrectAnswers(Number(storedCorrectAnswers)); // Ensure the value is a number
        setWrongAnswers(Number(storedWrongAnswers)); // Ensure the value is a number
      }
    }, []);
          ...
          <div className="bg-white p-8 sm:p-12 rounded-3xl shadow-2xl transition-all duration-500 transform hover:scale-105">
            <div className="text-center mb-10">
              <h3 className="text-2xl sm:text-3xl font-semibold text-gray-800 flex items-center justify-center mb-4">
                ...
                Candidate:{" "}
                <span className="text-indigo-600 ml-2 font-bold">GUEST USER</span>
              </h3>
            ...
            <div className="flex justify-evenly items-center space-x-8 sm:space-x-12">
              ...
              <div className="relative w-48 sm:w-64 h-48 sm:h-64">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center bg-gradient-to-br from-indigo-600 to-indigo-800 text-white rounded-full shadow-2xl transform hover:scale-110 transition-all">
                  ...
                  <p className="text-4xl sm:text-6xl font-extrabold">{CandidateScore}</p>
